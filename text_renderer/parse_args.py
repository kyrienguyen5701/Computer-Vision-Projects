...
def parse_args():
    ...
    parser.add_argument('--random', action='store_true', default=False,
                        help='Randomize the length of a string in a image, from 1 to --length')
    ...
    parser.add_argument('--chars_file', type=str, default='./data/chars/ja.txt',
    ...
    parser.add_argument('--fonts_list', type=str, default='./data/fonts_list/ja.txt',
