...
def corpus_factory(corpus_mode: str, chars_file: str, corpus_dir: str, length: int, random: bool):
    corpus_classes = {
        "random": RandomCorpus,
        "chn": ChnCorpus,
        "eng": EngCorpus,
    ...
    return corpus_class(chars_file=chars_file, corpus_dir=corpus_dir, length=length, random=random)
